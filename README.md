...
Market Insight  ──▶  Positioning  ──▶  Narrative  ──▶  GTM Execution  ──▶  Measurement
      │                   │                │                  │                  │
  Customer           Messaging         Sales              Launch             Retention
 Interviews         Framework        Enablement          Campaigns           Metrics
      │                   │                │                  │                  │
  Competitor          Value Prop       Battle Cards       Landing Pages       Day-7 Data
  Analysis            Hierarchy        One-Pagers         Email Sequences     Pipeline
```
...
147%    QoQ increase in inbound demand through repositioned GTM strategy
 50+    Enterprise demo requests generated within 30 days of product launch
 25%    Increase in landing page conversion through restructured messaging
 18%    Improvement in day-7 user retention through lifecycle campaign redesign
 25%    Organic traffic growth through SEO-optimised content strategy
```
...
*All frameworks and templates in this repository are based on real work and are shared for the PMM community. Feel free to adapt and use them.*
